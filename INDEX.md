...
- [mechanics/game-modes.md](mechanics/game-modes.md) — every mode, its unlock, where to find it in the game UI, and how its rules change team building — read when the question names a mode or an in-game event, or asks where a mode is.
