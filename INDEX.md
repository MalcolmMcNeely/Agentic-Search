...
- [mechanics/recruitment.md](mechanics/recruitment.md) — the four summon banners, their currencies, rates and pity counts, the two wishlists, and Stargaze Station with its target priority — read when the question is about summoning, pulling, diamonds, Invite Letters, a rate-up banner, a wishlist, or which Celestial or Hypogean to chase.
