...
| Galahad | `?` | Time Recast |
| Zanie | `?` | Precision Overload |
| Hugin | `?` | Steelbound Kinship |

**Eleven Exclusive Equipments are owned, and one of them has run out of levels.** **Taichi & Agumon and Yamato & Gabumon both stand at Supreme+**, the top ascension tier, and no other hero on the account is there. **Eironn, Shemira, Smokey & Meerky, Bonnie, Aurora, Faramor, Galahad, Zanie and Hugin are all Supreme**, one step behind.

**Galahad, Zanie and Hugin are the three newest, and their weapon levels are `?`.** Read each off the hero's weapon screen. Until then no spend queue below can rank them, because the level decides both the currency and the price. All three sit at Supreme, so each has a **+10** ceiling.
...
**Faramor's is the only one that pays the other four heroes rather than its own.** **Bitter Requiem** lets **every ally inside his magic circle deal extra true damage worth 75% of their own ATK**, rising to 85% at the weapon's top. Every other EX skill here multiplies the hero wearing it. The Digimon pair are the two first picks in any mode that does not lock Dimensional heroes out. **Eironn and Shemira are the two strongest heroes the account can field in the modes that do**, Eironn because the towers take Wilders and Shemira because she carries the Tower of Eternity, Arena, Skyclops, Darkswarm and solo comps at once. **Bonnie, Faramor, Zanie and Hugin are the A-Level heroes on the account that reached Supreme.** Bonnie's and Zanie's copies all came off banners, because no shop stocks either of them; Faramor's and Hugin's came off the Dream Store shelf. See [../mechanics/heroes/taichi-agumon.md](../mechanics/heroes/taichi-agumon.md), [../mechanics/heroes/yamato-gabumon.md](../mechanics/heroes/yamato-gabumon.md), [../mechanics/heroes/eironn.md](../mechanics/heroes/eironn.md), [../mechanics/heroes/shemira.md](../mechanics/heroes/shemira.md), [../mechanics/heroes/smokey-meerky.md](../mechanics/heroes/smokey-meerky.md), [../mechanics/heroes/bonnie.md](../mechanics/heroes/bonnie.md) and [../mechanics/heroes/faramor.md](../mechanics/heroes/faramor.md).
...
**The eleven EX weapons sit at two ceilings, because every upgrade band needs a higher ascension tier than the last.** Levels 6 to 10 need Supreme, and 11 upwards needs Supreme+. **The Digimon pair are the only two heroes past that second gate**, and the other nine all cleared the first one, so **the only weapon blocked on a tier is Smokey & Meerky's, and it is blocked because it is finished rather than because it is stuck.**
...
**The two Digimon finishes are third and fourth, and the Arena case for them is no longer safe.** allclash names +15 the Arena target. **Taichi & Agumon goes first of the two**, because he carries the running Arena attack comp, the push comp, the Snow Stomper comp and King Croaker. Each costs **500 Temporal Essence**, a third more than Shemira's, for an effect no source has published.

**`unverified` whether those five levels pay anything in Arena at all.** Arena caps hero levels at a baseline of 151 plus about 10% and **adjusts equipment levels to match**, and no source says whether Exclusive Equipment is included in that. **Take them after Shemira and Aurora**, and do not move them up the queue for Arena rank until one battle settles it: open the Arena formation screen and read whether Agumon's EX bonus still shows at +10. See [../mechanics/arena.md](../mechanics/arena.md) and [../mechanics/equipment-and-charms.md](../mechanics/equipment-and-charms.md).

**Soul Sigils buy Arena rank where Essence may not.** Ascension is the one investment the baseline provably leaves alone, because unlocked skills are untouched. See [progression.md](progression.md).
...
**The twelfth EX weapon is one tier away on five heroes, and one of them is far cheaper than the rest.** Daimon, **Thador**, **Kruger**, **Kordan** and **Solise** are all **Mythic**.

**Solise is the pick, and the price is why.** She is the only **S-Level** hero in that list, so Mythic to Mythic+ costs her **2 Soul Sigils and 100 Faction Acorns**, the price every EX weapon on this account has already paid. Every other name on the list is A-Level at **12 sigils**, six times as many, and Daimon's Level is `unverified`.

Her weapon unlocks **Resonant Bloom**: her healing waves send a damaging water ring from every Bulbsprite they touch. She stands in **three fielded comps**, Arcane Labyrinth, Tower of Nature and Battle Drills Team 2, and she feeds the Nature tower at 55 of 90. Her sigil route is **slot 5 of the Epic Recruitment wishlist**, which she took off Shakir because 2 sigils for an Exclusive Equipment beats about 4 for a Hero Focus. See [../mechanics/heroes/solise.md](../mechanics/heroes/solise.md) and [../mechanics/recruitment.md](../mechanics/recruitment.md).

**Kruger stays the cheapest to *reach*, not to buy**, because the Dream Store sells his copies for fragments rather than sigils. **Thador, Kordan and Solise all need a banner.** Kordan is the worst-supplied of the three: he is A-Level at **12 sigils** and the Dream Store does not stock him, so his copies have no fragment route at all. Sigil supply is the constraint, not the tier. See [roster.md](roster.md), [../mechanics/recruitment.md](../mechanics/recruitment.md), [../mechanics/dream-store.md](../mechanics/dream-store.md) and [../mechanics/guild-store.md](../mechanics/guild-store.md).
