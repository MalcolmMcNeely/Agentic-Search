...
**This is the archetype the account has invested in.** Aurora is **Mythic+ with her EX weapon at +5**, and all three parts of her kit read the same number, the count of allied summons. Dream Veil buffs them, the EX weapon buffs them a further 8%, and Hero Focus turns them into her own ATK at +10% plus 1% per summon belonging to a **different** ally, up to 5. So the buff goes out twice and comes home once, and every part wants the summon sources spread across different heroes rather than piled on one. See [heroes/aurora.md](heroes/aurora.md).
...
- **Summon stack.** Aurora is **Mythic+ with her EX weapon at +5**, the only hero outside the Digimon pair and Eironn carrying one, and twelve owned heroes put summons on the field. Rolan stacks on top: two Celestials wildcard into any core at once.
- **Boss amplify.** **Rolan** is the engine, because his Ultimate clone works at the tier he is at. **Galahad** is one ascension and **2 Soul Sigils** from taking the job off him. Her Time Recast needs **Mythic+** and she is **Mythic**, so she plays as the payload only until that step is paid.
...
- **Control.** **Bonnie is Supreme**, the only A-Level hero on the account to get there, with **Blight Surge** live. Cyran is Epic. **Viperian** adds Energy denial across the whole enemy line, at Elite. **Lily May** adds a counter-pick layer: her passive punishes enemy Ultimates, so she is an Arena answer to Ultimate-reliant comps, including enemy Eironn teams. **Atalanta** is the newest pick here and the densest: a 2s stun, a 3s immobilise and a knockback, all from one Marksman slot, at **Epic**. **Damian** reaches the enemy backline that nothing else on the roster reaches, at **Elite**.
...
**Wilder and Mauler are both 10 deep and Graveborn is 9.** Only Lightbearer is deeper, at 13. Wilder counters Graveborn, and Legend Trial's Tower of Nature is faction-locked to Wilder. See [legend-trial.md](legend-trial.md) and [factions.md](factions.md).
