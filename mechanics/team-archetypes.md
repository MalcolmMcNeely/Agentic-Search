...
**Engine:** Energy and Morale feeders. Rowan throws coins that restore Energy. Rolan clones an ally's Ultimate outright, and stacks Morale by faction. Thador hands out Energy at battle start.
...
**Hewynn is the account's strongest healer** and takes this slot ahead of the two above when the team is simply dying. Rain Prayer heals every ally for up to 115% HP per second across 9s, Revitalize strips debuffs, and Tranquil adds team-wide damage reduction while the Ultimate runs, so she pays into both sums at once. **Fay** and **Smokey & Meerky** heal and buff ATK together, and Smokey & Meerky are **Mythic**, the joint-highest tier on the account outside the Digimon pair. **Hammie** does the same job at Rare, and she cannot ascend, so she falls off and is a filler pick only.
...
**The Wilder bench is 9 deep, and Graveborn now matches it.** Only Lightbearer is deeper. Wilder counters Graveborn, and Legend Trial's Tower of Nature is faction-locked to Wilder. See [legend-trial.md](legend-trial.md) and [factions.md](factions.md).
