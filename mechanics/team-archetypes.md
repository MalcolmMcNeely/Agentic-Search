...
**In Arena the pattern is a swap rather than a comp.** Eironn takes Pandora's slot in attack A against a spread defence, and the cost is the Dimensional 3-core. See [arena.md](arena.md) and [pvp-team-building.md](pvp-team-building.md).
