...
**Every battle mode lives in the Everlight**, the hub screen. Arena and Dream Realm are both reached from there, so the walk is the same for all of them: open the Everlight, then pick the mode.
