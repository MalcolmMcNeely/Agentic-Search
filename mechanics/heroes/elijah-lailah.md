...
**Two bodies, one hero.** Elijah and Lailah deploy as two units and fight independently, but they share a single HP and Energy pool, and that pool carries **+50% max HP**. One is the Melee Twin and one is the Ranged Twin, and two of their effects key off which is which.

**Ultimate, Starlight Waltz.** The pair dance and give **every ally +60 Haste for 7s**. The duration grows with level: 7.5s at 51, 8s at 111, 8.5s at 171, 9s at 231.
...
**Skill 2.** A small shield on the weakest ally, a **Blind** pulse 1 tile around the Ranged Twin, and a **Knockback** around the Melee Twin.
